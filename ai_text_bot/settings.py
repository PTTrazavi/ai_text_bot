"""
Django settings for ai_text_bot project.
...
SECRET_KEY = '7i1x*&0&ix6q)6u-de^)wnk)j7hjf5s4)&6^52-!-zkm_btoky'
...
WSGI_APPLICATION = 'ai_text_bot.wsgi.application'
